...
@implementation CameraViewControllerDelegateAction
...
-(void)setResult:(void (^)(NSURL *))result{
    CameraViewControllerDelegateAction * delegateAction = [[CameraViewControllerDelegateAction alloc] initWithAction:result];
