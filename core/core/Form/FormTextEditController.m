...
//import UIKit
//
//public class FormTextEditController: UITableViewController,UITableViewDelegate,UITableViewDataSource{
//    
//    
...
//        
//        var ok:UIBarButtonItem = UIBarButtonItem();
//        ok.title = "确定";
//        ok.action = "okClick:";
//        ok.target = self;
