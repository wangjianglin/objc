...
//        
//        var jsonParams = "{\"timestamp\":\(HttpUtils.timestamp),\"sequeueid\":\(HttpUtils.sequeue),\"data\":\(package.json.toString())}";
//        
...
//        
//        let jsonParams2 = plainData?.base64EncodedStringWithOptions(NSDataBase64EncodingOptions(0))
//        
